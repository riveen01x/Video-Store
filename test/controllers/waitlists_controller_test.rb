...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Waitlist.count') do
      post waitlists_url, params: { waitlist: { email: @waitlist.email, video_id: @waitlist.video_id } }
    end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { email: @waitlist.email, video_id: @waitlist.video_id } }
