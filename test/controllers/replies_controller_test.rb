...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { content: @reply.content, review_id: @reply.review_id } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { content: @reply.content, review_id: @reply.review_id } }
