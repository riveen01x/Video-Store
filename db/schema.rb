...
ActiveRecord::Schema.define(version: 2022_03_10_114807) do
  ...
  create_table "copies", force: :cascade do |t|
    ...
    t.index ["video_id"], name: "index_copies_on_video_id"
  end
  ...
  create_table "rent_items", force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "index_rent_items_on_customer_id"
  end
  ...
  create_table "videos", force: :cascade do |t|
    ...
    t.integer "dvd_copies"
    t.integer "vhs_copies"
    t.integer "bluray_copies"
    t.integer "stock"
  ...
  add_foreign_key "copies", "videos"
  add_foreign_key "line_items", "carts"
  add_foreign_key "line_items", "videos"
  add_foreign_key "pay_charges", "pay_customers", column: "customer_id"
  add_foreign_key "pay_charges", "pay_subscriptions", column: "subscription_id"
  add_foreign_key "pay_payment_methods", "pay_customers", column: "customer_id"
  add_foreign_key "pay_subscriptions", "pay_customers", column: "customer_id"
  add_foreign_key "rent_items", "customers"
